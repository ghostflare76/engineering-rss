...
![AI](https://img.shields.io/badge/AI-Powered-00D9FF?style=for-the-badge&logo=google)
...
```mermaid
graph LR
    A[🌐 20+ 테크 기업 블로그] -->|자동 수집| B[🤖 AI 분석 엔진]
    B -->|핵심 추출| C[📝 구조화된 요약]
    C -->|자동 발송| D[📧 이메일 뉴스레터]
    
    style A fill:#4285F4,stroke:#333,stroke-width:2px,color:#fff
    style B fill:#EA4335,stroke:#333,stroke-width:2px,color:#fff
    style C fill:#FBBC04,stroke:#333,stroke-width:2px,color:#333
...
### Data Processing
![RSS](https://img.shields.io/badge/RSS_Feed-FFA500?style=for-the-badge&logo=rss&logoColor=white)
![HTML](https://img.shields.io/badge/HTML5-E34F26?style=for-the-badge&logo=html5&logoColor=white)

### Email Delivery
![SMTP](https://img.shields.io/badge/SMTP-0078D4?style=for-the-badge&logo=gmail&logoColor=white)
